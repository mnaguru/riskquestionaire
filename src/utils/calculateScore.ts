...
export async function generatePDFReport(data: PDFReportData): Promise<void> {
  ...
  try {
    ...
    // Create new PDF document with better configuration
    const pdf = new jsPDF({
    ...
    // === COMPREHENSIVE STRESS TESTING ANALYSIS SECTION ===
    checkPageBreak(90);
    ...
    // Example: Table-style scenario summary
    const scenarioTable = [
    ...
    // === END OF STRESS TEST SECTION ===

    // ...rest of your code continues here...

    console.log('Adding submitter information...');
    ...
    // ...rest of your original code (financial profile, investment strategy, etc.)...
    // No changes needed to the rest of the function.
    
    // (Omitted for brevity: see your original function for next steps, disclaimer, footer, etc.)
  } catch (error) {
